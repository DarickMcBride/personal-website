    ...
    <div className="flex  flex-col items-center z-10">
      ...
      <div className="space-y-3">
        ...
        <div className="carousel ">
          <div
            id="item1"
            className="carousel-item flex flex-col items-center w-full"
          >
          ...
          <div
            ...
            className="carousel-item flex flex-col items-center w-full"
          >
            <h2 className="text-secondary font-semibold text-lg">TypeScript</h2>
            <p>
          ...
          >
            ...
            <p>
              ...
              code suggestions and automation, making coding more efficient and
              helping me deliver high-quality code faster.
            </p>
          </div>
        </div>
