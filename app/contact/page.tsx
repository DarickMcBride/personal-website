...
const Page = () => {
  return (
    <div id="contact">
      <Box display="flex" flexDirection="column" sx={{ pb: 3 }}>
          ...
          <Stack spacing={1}>
            ...
            <Box>
              ...
              <Typography gutterBottom>
                ...
                projects I&rsquo;ve worked on. If you have any questions or
                would like to know more, I&rsquo;d be happy to discuss it.
                I&rsquo;m looking forward to hearing from you and engaging in
                meaningful conversations. Whether it&rsquo;s about business
                collaborations, tech discussions, or just a friendly chat,
                I&rsquo;m here to connect. Let&rsquo;s get in touch and explore
                the possibilities!
              </Typography>
            </Box>
            <Typography>
              ...
              opportunities, tech discussions, or just a friendly chat,
              I&rsquo;m here to connect. Let&rsquo;s get in touch and explore
              the possibilities!
            </Typography>
          </Stack>
