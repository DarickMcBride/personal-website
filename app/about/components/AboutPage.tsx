...
const AboutPage = () => {
  ...
  return (
    <div id="about">
      ...
      <Typography sx={{ pb: 1 }} variant="body1" gutterBottom>
        Here are some of the skills I&rsquo;ve acquired over the years:
      </Typography>
      <Typography
      ...
      >
        ...
        Skilled in designing elegant and user-friendly interfaces with Material
        UI components.
        <br />
        ...
        Skilled in C# programming for back end web development.
        <br />
        <span style={{ color: theme.palette.secondary.main }}>
          - Node.js:
        </span>{" "}
        ...
        and assistance.
        <br />{" "}
        <span style={{ color: theme.palette.secondary.main }}>- SQL:</span>{" "}
