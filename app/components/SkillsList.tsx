  ...
  return (
    <ul className="list-disc list-inside space-y-4">
      ...
      <li>
        ...
        Experienced in building server-side rendered applications using Next.js.
      </li>
      <li>
        <span className="text-secondary font-semibold">CSS:</span> Skilled in
        styling web pages using CSS.
      </li>
      <li>
        <span className="text-secondary font-semibold">Tailwind CSS:</span>{" "}
        Proficient in creating responsive and customizable designs using
        Tailwind CSS.
      </li>
      <li>
        <span className="text-secondary font-semibold">Git:</span> Experienced
      ...
      <li>
        <span className="text-secondary font-semibold">GitHub Copilot:</span>{" "}
        Proficient in leveraging GitHub Copilot for enhanced coding productivity
        and assistance.
      </li>
      <li>
        <span className="text-secondary font-semibold">SQL:</span> Proficient in
        working with relational databases and writing SQL queries to manage and
        retrieve data.
      </li>
    </ul>
  );
