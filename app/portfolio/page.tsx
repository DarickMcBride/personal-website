    ...
    <div className="flex flex-col items-center">
      ...
      <div className="space-y-3">
        ...
        <p className="text-lg  text-base-content">
          ...
          testament to my growth and dedication in the realm of web development.
          I hope that my work not only speaks to my capabilities as a web
          developer, but also sparks a conversation about potential
          collaborations on future projects. Each project links to the source
          code on GitHub. Enjoy your journey through my portfolio!
        </p>
        <Projects />
      </div>
    </div>
